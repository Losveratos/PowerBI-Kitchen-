...
(function () {
  ...
  const DE = {
    ...
    viz: {
      ...
      varint: { label: 'Integrierte Varianzanalyse', note: '3 Ebenen: Δ% · Δ-Brücke · Säulen AC/FC vs PL, gemeinsame Zeitachse.' },
      ...
      kpi: { label: 'KPI-Kachel (ChartKitchen)', note: 'Große Zahl, Δ-Zeile grün/rot, optional Sparkline.' },
    ...
    tpl: {
      ...
      pnl: { label: 'Monatsreport GuV', desc: 'GuV-Wasserfall links, Positionen als Berichtstabelle rechts, Kommentarzeile unten.' },
  ...
  const EN = {
    ...
    viz: {
      ...
      varint: { label: 'Integrated variance analysis', note: '3 tiers: Δ% · Δ bridge · columns AC/FC vs PL, shared time axis.' },
      ...
      kpi: { label: 'KPI tile (ChartKitchen)', note: 'Large number, Δ row green/red, optional sparkline.' },
    ...
    tpl: {
      ...
      pnl: { label: 'Monthly P&L report', desc: 'P&L waterfall on the left, line items as a report table on the right, comment row at the bottom.' },

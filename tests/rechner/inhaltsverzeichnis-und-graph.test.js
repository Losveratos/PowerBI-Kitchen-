...
const want=['wizard','s0','s-map','d-tree','s1','s1b','s2','s3','d-s4','s5','readguide','decision-path','kpi-allowed','certainty','rclasses','nulloption','cashout','capex','d-charts','d-text','s-grenzen','d-s6','d-anhang'];
...
ok('TOC: Grenzen stehen zwischen Ergebnis und Details',ids.indexOf('s5')<ids.indexOf('s-grenzen')&&ids.indexOf('s-grenzen')<ids.indexOf('d-s6'),ids.slice(ids.indexOf('s5')).slice(0,3).join(',')+' … '+ids[ids.indexOf('s-grenzen')]+','+ids[ids.indexOf('s-grenzen')+1]);

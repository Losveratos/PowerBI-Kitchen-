...
Bei HTML-Custom-Visuals in Power BI wird der HTML-Code in eine DAX-Formel geschrieben, die als Measure in das HTML-Visual gezogen wird. Ein Kunde entschied sich trotz einer passenderen Custom-Visual-Alternative für die Umsetzung mit dem Standard-Visual, weil der Einkaufsprozess für kostenpflichtige Custom Visuals ein großes Hindernis darstellt. Deneb-Visuals erfordern Coding beziehungsweise Scripting mit Vega beziehungsweise Vega-Lite, sobald ein Endanwender einen speziellen Visualisierungs-Task lösen will, der im Standardumfang von Power BI nicht möglich ist.
...
| --- | --- | --- | --- |
| [Deneb](deneb.md) | gegensatz | belegt | 5 |
| [Zebra BI](zebra-bi.md) | ersetzt | belegt | 5 |
| [Deneb](deneb.md) | teil-von | belegt | 5 |
| [IBCS](ibcs.md) | setzt-voraus | belegt | 14 |
| [Visualisierung](visualisierung.md) | ko-vorkommen | heuristik | 63 |
...
| [Power BI Desktop](power-bi-desktop.md) | ko-vorkommen | heuristik | 8 |
...
| [Python](python.md) | ko-vorkommen | heuristik | 4 |
| [Datenmodellierung](datenmodellierung.md) | ko-vorkommen | heuristik | 4 |
...
| [Fabric & Power BI Quarterly · 2025 Q3](https://www.youtube.com/watch?v=lZvpCBMKASM) | — | nur-zeitstempel | [07:46](https://www.youtube.com/watch?v=lZvpCBMKASM&t=466s) · [28:24](https://www.youtube.com/watch?v=lZvpCBMKASM&t=1704s) |

...
- **Stand:** v0.10 · 09/2026 (drei Ebenen nach Shneiderman; Annahmen-Audit 11.09.2026; Chart-Mix, Lernkurve, Null-Option; Varianten-Anfaelligkeit, Vorlagenbibliothek und Lizenz-Anker sichtbar) · Sprache DE · rein clientseitig, keine Server-Anbindung
...
- **Ebene 1, Ueberblick:** drei Eingaben (Ersteller, Viewer, Betriebsmodell) oder ein Preset, dazu der Lizenz-Anker fuer Paid (Inforiver-Niveau 33 €, Mischpreis 80 €, Zebra-Liste 270 €) und der Schalter „Vorlagenbibliothek fuer Deneb und Core vorhanden“ (Default aus, weil der IBCS Chart Builder ein eigenes Projekt ist); der Satz nennt, wer bei allen drei Ankern mit und ohne Bibliothek vorn liegt; ein Chart mit den Kosten je Viewer und Jahr als P10–P90-Band je Ansatz; ein Satz mit Rangfolge, Faktoren und der Viewer-Zahl, ab der die Lizenz je Kopf dominiert; zwei Zeilen dazu, was belastbar ist und was nicht.
...
Quellenlage aller 46 Annahmen: 2 verifiziert (V), 8 Such-Snippet (S), 4 Faustregel (F), 9 simuliertes Expertenpanel (P), 23 Autoren-Schaetzung (E). Deshalb Bandbreiten statt Punktwerte, und deshalb steht die Herkunft an jedem Wert.

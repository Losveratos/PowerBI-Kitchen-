...
- **Stand:** v0.7 · 09/2026 (Annahmen-Audit 11.09.2026, siehe unten) · Sprache DE · rein clientseitig, keine Server-Anbindung
...
Rollout     = (Reports + Nachfrage je 1.000 Viewer + Nachfrage je Ersteller) × Charts/Report × Wiederverwendungs-Stunden × Betriebsmodell-Faktor
...
Quellenlage aller 37 Annahmen nach dem Audit: 2 verifiziert (V), 8 Such-Snippet (S), 3 Faustregel (F), 9 simuliertes Expertenpanel (P), 15 Autoren-Schaetzung (E). Deshalb Bandbreiten statt Punktwerte, und deshalb steht die Herkunft an jedem Wert.

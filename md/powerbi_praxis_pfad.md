...
7 Module · ≈ 2 Stunden · Kein Konto nötig · Rettungsdatei je Kapitel

> **⚠️ Du brauchst einen Windows-Rechner.** Power BI Desktop gibt es nicht für Mac, nicht fürs iPad und nicht fürs Handy. Das ist eine Entscheidung von Microsoft. Wenn du am Mac sitzt: Lies gern mit — mitmachen kannst du leider nicht.
...
6. Falls dich das Programm nach einer Datei fragt oder ein Startbildschirm erscheint: Schließ auch den. Du solltest jetzt eine große leere weiße Fläche sehen, oben ein Menüband mit **Datei · Start · Einfügen · Modellierung · Ansicht · Hilfe**.
...
![Menüband „Start" — der rote Rahmen zeigt „Daten abrufen".](../assets/praxis-pfad/modul-01-daten-abrufen.png)
...
8. Schau dir die Tabelle einmal ganz an: Klick links am Bildschirmrand auf das mittlere der drei Symbole — die **Tabellenansicht** (ein Gittersymbol). Jetzt siehst du die Daten wie in einer Tabelle.
...
![Derselbe Menüband-Bereich — jetzt ist „Daten transformieren" markiert.](../assets/praxis-pfad/modul-02-transformieren.png)
...
![Der Bereich „Visualisierungen“ — markiert ist das Symbol „Karte“.](../assets/praxis-pfad/modul-03-karte.png)
...
4. Klapp im Bereich **Daten** die Tabelle **verkaeufe_2025** auf und setz das Häkchen bei **Umsatz**. In dem Kästchen erscheint eine Zahl.
5. Die Zahl steht dort abgekürzt: **2,10 Mio.** Power BI kürzt große Zahlen von sich aus — „Mio." heißt Millionen. Das ist so in Ordnung und bleibt auch so; für die Frage „wie viel insgesamt?" reicht diese Genauigkeit völlig.
...
>
> Willst du es ganz genau wissen: Die Summe auf den Euro beträgt **2.100.088**. Sehen kannst du sie, indem du in der Tabellenansicht die Spalte **Umsatz** anklickst und unter **Spaltentools** die **Dezimalstellen** auf `0` stellst — nötig ist das aber nicht.
>
...
![Ein Klick im Datenschnitt (rot markiert) verändert alle Bilder der Seite gleichzeitig.](../assets/praxis-pfad/modul-04-datenschnitt.png)

6. Klick noch einmal auf **Technik**, um die Auswahl aufzuheben. Alles ist wieder wie vorher.
...
5. Schau rechts unter **Visualisierungen** in das Feld **Wert**. Dort steht `Summe von Marge`. Klick auf den kleinen **Pfeil nach unten** direkt daneben.
6. Es klappt eine Liste auf: **Summe · Mittelwert · Minimum · Maximum · Anzahl (eindeutig) · Anzahl** und weitere. Wähle **Mittelwert**.

![Das aufgeklappte Menü — „Mittelwert“ ist der Eintrag, den du brauchst.](../assets/praxis-pfad/modul-05-aggregation.png)
...
![Datei → Exportieren — markiert ist „In PDF exportieren“.](../assets/praxis-pfad/modul-06-export.png)

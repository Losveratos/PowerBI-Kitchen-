...
Stand: 2026-09-18 · Version 0.1 · Spec-Hash `4d42e99d` · erstellt mit MockupKitchen byDatenWG 0.3
...
- Fußleiste „Stand: 18.09.2026 · Quelle: DWH · Kontakt: Controlling".
...
| 1.5 | Δ PL je Produktlinie | Wasserfall horizontal + Varianz, AC/PL, ChartKitchen | Kategorie / Achse: Category; AC · Ist-Wert: AC; Referenz (PL / PY / BU): PL | – | – | offen | Klick auf eine Kategorie springt in die Detailseite. Offen: Sortierung nach Δ oder AC? · → Detail Produktlinie |
| 1.6 | Umsatz AC/FC vs PL je Monat (in T€) | Integrierte Varianzanalyse, AC/PL/FC, ChartKitchen | Zeit / Periode: Month; AC · Ist-Wert: AC; Referenz (PL / PY / BU): PL; FC-Flag (1/0): IsForecast | – | – | offen | – |
...
- Von „Übersicht" (mk_7rbkjp5) nach „Detail Produktlinie" (Drill-through auf DimProduct.Category)

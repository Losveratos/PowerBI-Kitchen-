...
pbir pages background "Test.Report/Detail Produktlinie.Page" --color "#F4F4F1" --transparency 0
...
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.fill.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.fill.fillColor" --value "#C25A2D"
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.outline.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.text.text" --value "☰ Filter"
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.text.fontSize" --value 10
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.text.fontColor" --value "#FFFFFF"
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.text.horizontalAlignment" --value center
pbir set "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual.text.verticalAlignment" --value middle
pbir visuals position "Test.Report/Detail Produktlinie.Page/chrome_burger.Visual" --z 5
...
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_bg.Visual.shape.tileShape" --value rectangleRounded
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_bg.Visual.shape.rectangleRoundedCurve" --value 8
...
pbir visuals position "Test.Report/Detail Produktlinie.Page/chrome_filter_bg.Visual" --z 20
...
pbir visuals position "Test.Report/Detail Produktlinie.Page/chrome_filter_title.Visual" --z 22

# Schliessen-Button des Panels — Ziel ist das Lesezeichen 'Filter schliessen' (siehe navigation.md)
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.fill.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.outline.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.text.text" --value "✕"
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.text.fontSize" --value 11
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.text.fontColor" --value "#0F1E2E"
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.text.horizontalAlignment" --value center
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual.text.verticalAlignment" --value middle
pbir visuals position "Test.Report/Detail Produktlinie.Page/chrome_filter_close.Visual" --z 24
...
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.fill.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.outline.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.text.text" --value "Detail: gewählte Produktlinie"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.text.fontSize" --value 11
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.text.fontColor" --value "#0F1E2E"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.text.horizontalAlignment" --value left
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.text.verticalAlignment" --value top
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual" --z 10
...
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.background.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.background.color" --value "#FFFFFF"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.background.transparency" --value 0
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.border.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.border.color" --value "#E5E7EB"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.border.width" --value 1
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.dropShadow.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual.border.radius" --value 8
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.background.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.background.color" --value "#FFFFFF"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.background.transparency" --value 0
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.border.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.border.color" --value "#E5E7EB"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.border.width" --value 1
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.dropShadow.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual.border.radius" --value 8
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.background.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.background.color" --value "#FFFFFF"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.background.transparency" --value 0
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.border.show" --value true
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.border.color" --value "#E5E7EB"
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.border.width" --value 1
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.dropShadow.show" --value false
pbir set "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual.border.radius" --value 8

# Inhalt ueber die Chrome-Flaechen legen (--from-json vergibt immer z=0)
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_v04_Einzelpositionen.Visual" --z 10
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_v05_Verlauf_24_Monate.Visual" --z 10
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_v01_Detail_gewahlte_Produktlinie.Visual" --z 10

# Slicer (Overlay-Panel)
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_slicer1_Year.Visual" --z 24
pbir visuals position "Test.Report/Detail Produktlinie.Page/p2_slicer2_Region.Visual" --z 24

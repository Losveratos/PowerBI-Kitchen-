...
|---|---|---|---|---|---|
| 1 | Übersicht | `Ubersicht.Page` | – | 7 | – |
| 2 | Detail Produktlinie | `Detail_Produktlinie.Page` | – | 5 | Drill-through-Ziel aus der Übersicht; zeigt Einzelpositionen der gewählten Produktlinie. |
...
```bash
# Übersicht / p1_v05_PL_je_Produktlinie → Detail Produktlinie
...
pbir bookmarks visuals "Test.Report" "Filter öffnen · Übersicht" "chrome_filter_bg" "chrome_filter_title" "chrome_filter_close" "p1_slicer1_Year" "p1_slicer2_Region"
pbir add bookmark "Test.Report" "Filter schließen · Übersicht" --no-data --no-current-page
pbir bookmarks visuals "Test.Report" "Filter schließen · Übersicht" "chrome_filter_bg" "chrome_filter_title" "chrome_filter_close" "p1_slicer1_Year" "p1_slicer2_Region"
...
pbir visuals hide "Test.Report/Übersicht.Page/p1_slicer1_Year.Visual"
pbir visuals hide "Test.Report/Übersicht.Page/p1_slicer2_Region.Visual"
...
pbir bookmarks visuals "Test.Report" "Filter öffnen · Detail Produktlinie" "chrome_filter_bg" "chrome_filter_title" "chrome_filter_close" "p2_slicer1_Year" "p2_slicer2_Region"
pbir add bookmark "Test.Report" "Filter schließen · Detail Produktlinie" --no-data --no-current-page
pbir bookmarks visuals "Test.Report" "Filter schließen · Detail Produktlinie" "chrome_filter_bg" "chrome_filter_title" "chrome_filter_close" "p2_slicer1_Year" "p2_slicer2_Region"
#   Grundzustand: Panel ausgeblendet
...
pbir visuals hide "Test.Report/Detail Produktlinie.Page/p2_slicer1_Year.Visual"
pbir visuals hide "Test.Report/Detail Produktlinie.Page/p2_slicer2_Region.Visual"

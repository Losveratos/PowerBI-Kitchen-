...
pbir set "Test.Report/Detail Produktlinie.Page/chrome_filter_bg.Visual.shape.rectangleRoundedCurve" --value 12
...
pbir visuals position "Test.Report/Detail Produktlinie.Page/mk_slicer_Year_p2.Visual" --z 24
pbir visuals position "Test.Report/Detail Produktlinie.Page/mk_slicer_Region_p2.Visual" --z 24
